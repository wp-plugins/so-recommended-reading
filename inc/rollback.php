...
function sorr_rollback() {
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'complete'                        => __( 'The WP Rollback plugin has been successfully installed and activated. Now please have a look at the Plugins page, you will see the word Rollback under the SO Recommended Reading plugin. Click on it and Roll the version back to version 1.3.1. Once you have done that, you can uninstall the WP Rollback plugin (or keep it as a handy tool if you wish). Thank you for helping out, much appreciated indeed!', 'tgmpa' ),
