...
* <strong>Please read carefully.</strong><br />We have decided to revert to semantic versioning of the SO Recommended Reading plugin.<br />Unfortunately this cannot be done automatically and we need you to manually install version 1.3.1 of the plugin.<br />You can do that by using the WP Rollback plugin that we have included with this update.<br />After installing the WP Rollback plugin, you can have a look at the Plugins page and will see the word Rollback under the SO Recommended Reading plugin.<br />Click on it and Roll the version back to <strong>version 1.3.1</strong>. Once you have done that, you can uninstall the WP Rollback plugin (or keep it as a handy tool if you wish). Of course you should not update to this 2222.22.22 version anymore, even if you see the notice again, because then you will enter an infinite loop of updates…<br />Apologies for any inconvenience.<br />Thank you for helping out, much appreciated indeed!
* date: 2015.06.21
